...
void main() {
  ...
  group('AppTheme', () {
    test(
      'lightTheme has M3 enabled, correct Shadcn colors and explicit primaryContainer tokens',
      () {
    ...
    test(
      'darkTheme has M3 enabled, correct Shadcn colors and explicit primaryContainer tokens',
      () {
  ...
  group('MultiStepFormScreen Theme Contrast', () {
    testWidgets(
      'renders active step avatar badge text and step header card with high-contrast theme colors in light mode',
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          MaterialApp(
            ...
            home: const Scaffold(body: MultiStepFormScreen()),
          ),
        );
    ...
    testWidgets(
      'renders active step avatar badge text and step header card with high-contrast theme colors in dark mode',
      (WidgetTester tester) async {
        tester.view.physicalSize = const Size(800, 1200);
        tester.view.devicePixelRatio = 1.0;
        addTearDown(tester.view.resetPhysicalSize);
  ...
  group('AppShell Widget Tests', () {
    testWidgets(
      'renders top bar buttons and mobile navigation bar on mobile viewport',
      (WidgetTester tester) async {
