...
abstract class AppTheme {
  ...
  static ThemeData get lightTheme {
    const colorScheme = ColorScheme.light(
      ...
      primaryContainer: ShadcnColors.slate100,
      onPrimaryContainer: ShadcnColors.slate900,
  ...
  static ThemeData get darkTheme {
    const colorScheme = ColorScheme.dark(
      ...
      primaryContainer: ShadcnColors.slate800,
      onPrimaryContainer: ShadcnColors.slate50,
