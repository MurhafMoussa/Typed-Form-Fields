...
import '../../example/lib/screens/bloc_form_screen.dart';
...
void main() {
  ...
  group('BlocFormScreen Integration Tests', () {
    testWidgets('should render bloc form and handle submit flow', (tester) async {
      ...
      await tester.pumpWidget(buildTestableWidget(const BlocFormScreen()));
